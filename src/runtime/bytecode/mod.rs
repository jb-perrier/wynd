...
// use super::{InterpretedWordParameters, RuntimeError, Value};

// pub fn execute_bytecode<'a>(
//     runtime: &'a mut InterpretedWordParameters<'a>,
// ) -> Result<(), RuntimeError> {
//     loop {
//         let opcode = *runtime
//             .bytecode()
//             .get(runtime.ip())
//             .ok_or(RuntimeError::OutOfBoundWordAccess(runtime.ip()))?;
//         match opcode {
